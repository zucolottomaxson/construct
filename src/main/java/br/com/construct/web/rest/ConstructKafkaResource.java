...
@RestController
@RequestMapping("/api/construct-kafka")
public class ConstructKafkaResource {

    private final Logger log = LoggerFactory.getLogger(ConstructKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public ConstructKafkaResource(KafkaProperties kafkaProperties) {
